...
void LabelCollider::process() {
    ...
    // -> all labels of repeatGroups with higher priority have been added when reaching
    //    a collision pair with lower priority
    // This allows to remove repeated labels before


    //Label* repeatGroupStart = nullptr;
